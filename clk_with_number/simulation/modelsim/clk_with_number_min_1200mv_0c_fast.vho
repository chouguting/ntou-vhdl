...
-- onesec_out[3]	=>  Location: PIN_F1,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- decoded_out[0]	=>  Location: PIN_E11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- decoded_out[1]	=>  Location: PIN_F11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- decoded_out[2]	=>  Location: PIN_H12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- decoded_out[3]	=>  Location: PIN_H13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- decoded_out[4]	=>  Location: PIN_G12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- decoded_out[5]	=>  Location: PIN_F12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- decoded_out[6]	=>  Location: PIN_F13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- decoded_out[7]	=>  Location: PIN_D13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- temp	=>  Location: PIN_J6,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF clk_with_number IS
...
SIGNAL ww_decoded_out : std_logic_vector(7 DOWNTO 0);
SIGNAL ww_temp : std_logic;
...
SIGNAL \decoded_out[0]~output_o\ : std_logic;
SIGNAL \decoded_out[1]~output_o\ : std_logic;
SIGNAL \decoded_out[2]~output_o\ : std_logic;
SIGNAL \decoded_out[3]~output_o\ : std_logic;
SIGNAL \decoded_out[4]~output_o\ : std_logic;
SIGNAL \decoded_out[5]~output_o\ : std_logic;
SIGNAL \decoded_out[6]~output_o\ : std_logic;
SIGNAL \decoded_out[7]~output_o\ : std_logic;
SIGNAL \temp~output_o\ : std_logic;
...
SIGNAL \zero_to_nine_counter[0]~3_combout\ : std_logic;
SIGNAL \reset~input_o\ : std_logic;
SIGNAL \zero_to_nine_counter~1_combout\ : std_logic;
SIGNAL \zero_to_nine_counter~2_combout\ : std_logic;
SIGNAL \zero_to_nine_counter[2]~0_combout\ : std_logic;
...
SIGNAL \decoded_out~4_combout\ : std_logic;
SIGNAL \decoded_out~5_combout\ : std_logic;
SIGNAL \decoded_out~6_combout\ : std_logic;
...
\decoded_out[0]~output\ : cycloneiii_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
-- pragma translate_on
PORT MAP (
	i => \decoded_out~0_combout\,
	devoe => ww_devoe,
	o => \decoded_out[0]~output_o\);

-- Location: IOOBUF_X21_Y29_N30
\decoded_out[1]~output\ : cycloneiii_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
-- pragma translate_on
PORT MAP (
	i => \decoded_out~1_combout\,
	devoe => ww_devoe,
	o => \decoded_out[1]~output_o\);

-- Location: IOOBUF_X26_Y29_N2
\decoded_out[2]~output\ : cycloneiii_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
\decoded_out[3]~output\ : cycloneiii_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
-- pragma translate_on
PORT MAP (
	i => \decoded_out~2_combout\,
	devoe => ww_devoe,
	o => \decoded_out[3]~output_o\);

-- Location: IOOBUF_X26_Y29_N9
\decoded_out[4]~output\ : cycloneiii_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
-- pragma translate_on
PORT MAP (
	i => \decoded_out~3_combout\,
	devoe => ww_devoe,
	o => \decoded_out[4]~output_o\);

-- Location: IOOBUF_X28_Y29_N23
\decoded_out[5]~output\ : cycloneiii_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
-- pragma translate_on
PORT MAP (
	i => \decoded_out~4_combout\,
	devoe => ww_devoe,
	o => \decoded_out[5]~output_o\);

-- Location: IOOBUF_X26_Y29_N16
\decoded_out[6]~output\ : cycloneiii_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
-- pragma translate_on
PORT MAP (
	i => \decoded_out~5_combout\,
	devoe => ww_devoe,
	o => \decoded_out[6]~output_o\);

-- Location: IOOBUF_X23_Y29_N9
\decoded_out[7]~output\ : cycloneiii_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
-- pragma translate_on
PORT MAP (
	i => \decoded_out~6_combout\,
	devoe => ww_devoe,
	o => \decoded_out[7]~output_o\);

-- Location: IOOBUF_X0_Y24_N2
\temp~output\ : cycloneiii_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
-- Equation(s):
-- \count~4_combout\ = (\Add0~42_combout\ & !\Equal0~8_combout\)
...
-- Equation(s):
-- \Equal0~0_combout\ = (count(22) & (count(19) & (count(21) & count(20))))
...
-- Equation(s):
-- \count~0_combout\ = (!\Equal0~8_combout\ & \Add0~46_combout\)
...
-- Equation(s):
-- \Equal0~3_combout\ = (!count(18) & (!count(24) & (count(17) & count(23))))
...
-- Equation(s):
-- \count~8_combout\ = (!\Equal0~8_combout\ & \Add0~14_combout\)
...
-- Equation(s):
-- \count~9_combout\ = (\Add0~28_combout\ & !\Equal0~8_combout\)
...
-- Equation(s):
-- \Equal0~2_combout\ = (count(14) & (count(12) & count(13)))
...
-- Equation(s):
-- \Equal0~4_combout\ = (\Equal0~3_combout\ & (count(25) & \Equal0~2_combout\))
...
-- Equation(s):
-- \Equal0~6_combout\ = (count(5) & (!count(11) & (count(4) & count(6))))
...
-- Equation(s):
-- \Equal0~5_combout\ = (count(1) & (count(0) & (count(15) & !count(16))))
...
-- Equation(s):
-- \Equal0~7_combout\ = (count(3) & (\Equal0~6_combout\ & (count(2) & \Equal0~5_combout\)))
...
-- Equation(s):
-- \Equal0~1_combout\ = (!count(9) & (!count(8) & (!count(10) & !count(7))))
...
-- Equation(s):
-- \Equal0~8_combout\ = (\Equal0~0_combout\ & (\Equal0~4_combout\ & (\Equal0~7_combout\ & \Equal0~1_combout\)))
...
-- Equation(s):
-- \LessThan0~2_combout\ = (count(18) & (\Equal0~0_combout\ & ((\LessThan0~1_combout\) # (count(17)))))
...
-- Equation(s):
-- \rtl~0_combout\ = LCELL((!count(25) & (((!\LessThan0~2_combout\ & !count(23))) # (!count(24)))))
...
\zero_to_nine_counter[0]~3\ : cycloneiii_lcell_comb
-- Equation(s):
-- \zero_to_nine_counter[0]~3_combout\ = !zero_to_nine_counter(0)
...
-- pragma translate_on
PORT MAP (
	datac => zero_to_nine_counter(0),
	combout => \zero_to_nine_counter[0]~3_combout\);
...
PORT MAP (
	...
	d => \zero_to_nine_counter[0]~3_combout\,
	clrn => \reset~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => zero_to_nine_counter(0));

-- Location: LCCOMB_X27_Y28_N28
\zero_to_nine_counter~1\ : cycloneiii_lcell_comb
-- Equation(s):
-- \zero_to_nine_counter~1_combout\ = (zero_to_nine_counter(2) & (zero_to_nine_counter(3) $ (((zero_to_nine_counter(0) & zero_to_nine_counter(1)))))) # (!zero_to_nine_counter(2) & (zero_to_nine_counter(3) & ((zero_to_nine_counter(1)) # 
...
-- pragma translate_on
PORT MAP (
	dataa => zero_to_nine_counter(2),
	datab => zero_to_nine_counter(0),
	datac => zero_to_nine_counter(3),
	datad => zero_to_nine_counter(1),
	combout => \zero_to_nine_counter~1_combout\);

-- Location: FF_X27_Y28_N29
\zero_to_nine_counter[3]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \rtl~0clkctrl_outclk\,
	d => \zero_to_nine_counter~1_combout\,
	clrn => \reset~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => zero_to_nine_counter(3));

-- Location: LCCOMB_X27_Y28_N18
\zero_to_nine_counter~2\ : cycloneiii_lcell_comb
-- Equation(s):
-- \zero_to_nine_counter~2_combout\ = (zero_to_nine_counter(1) & (((!zero_to_nine_counter(0))))) # (!zero_to_nine_counter(1) & (zero_to_nine_counter(0) & ((zero_to_nine_counter(2)) # (!zero_to_nine_counter(3)))))
...
PORT MAP (
	dataa => zero_to_nine_counter(2),
	datab => zero_to_nine_counter(3),
	datac => zero_to_nine_counter(1),
	datad => zero_to_nine_counter(0),
	combout => \zero_to_nine_counter~2_combout\);

-- Location: FF_X27_Y28_N19
\zero_to_nine_counter[1]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \rtl~0clkctrl_outclk\,
	d => \zero_to_nine_counter~2_combout\,
	clrn => \reset~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => zero_to_nine_counter(1));

-- Location: LCCOMB_X27_Y28_N12
\zero_to_nine_counter[2]~0\ : cycloneiii_lcell_comb
-- Equation(s):
-- \zero_to_nine_counter[2]~0_combout\ = zero_to_nine_counter(2) $ (((zero_to_nine_counter(1) & zero_to_nine_counter(0))))
...
-- pragma translate_on
PORT MAP (
	datab => zero_to_nine_counter(1),
	datac => zero_to_nine_counter(2),
	datad => zero_to_nine_counter(0),
	combout => \zero_to_nine_counter[2]~0_combout\);

-- Location: FF_X27_Y28_N13
\zero_to_nine_counter[2]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \rtl~0clkctrl_outclk\,
	d => \zero_to_nine_counter[2]~0_combout\,
	clrn => \reset~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => zero_to_nine_counter(2));

-- Location: LCCOMB_X27_Y28_N16
\decoded_out~0\ : cycloneiii_lcell_comb
-- Equation(s):
-- \decoded_out~0_combout\ = (!zero_to_nine_counter(1) & (!zero_to_nine_counter(3) & (zero_to_nine_counter(2) $ (zero_to_nine_counter(0)))))
...
PORT MAP (
	...
	datab => zero_to_nine_counter(0),
	datac => zero_to_nine_counter(1),
	datad => zero_to_nine_counter(3),
	combout => \decoded_out~0_combout\);

-- Location: LCCOMB_X27_Y28_N22
\decoded_out~1\ : cycloneiii_lcell_comb
-- Equation(s):
-- \decoded_out~1_combout\ = (zero_to_nine_counter(2) & (!zero_to_nine_counter(3) & (zero_to_nine_counter(0) $ (zero_to_nine_counter(1)))))
...
-- Equation(s):
-- \Equal10~0_combout\ = (!zero_to_nine_counter(2) & (!zero_to_nine_counter(0) & (zero_to_nine_counter(1) & !zero_to_nine_counter(3))))
...
\decoded_out~2\ : cycloneiii_lcell_comb
-- Equation(s):
-- \decoded_out~2_combout\ = (!zero_to_nine_counter(3) & ((zero_to_nine_counter(2) & (zero_to_nine_counter(0) $ (!zero_to_nine_counter(1)))) # (!zero_to_nine_counter(2) & (zero_to_nine_counter(0) & !zero_to_nine_counter(1)))))
...
\decoded_out~3\ : cycloneiii_lcell_comb
-- Equation(s):
-- \decoded_out~3_combout\ = (zero_to_nine_counter(1) & (((zero_to_nine_counter(0) & !zero_to_nine_counter(3))))) # (!zero_to_nine_counter(1) & ((zero_to_nine_counter(2) & ((!zero_to_nine_counter(3)))) # (!zero_to_nine_counter(2) & 
-- (zero_to_nine_counter(0)))))
...
\decoded_out~4\ : cycloneiii_lcell_comb
-- Equation(s):
-- \decoded_out~4_combout\ = (!zero_to_nine_counter(3) & ((zero_to_nine_counter(2) & (zero_to_nine_counter(0) & zero_to_nine_counter(1))) # (!zero_to_nine_counter(2) & ((zero_to_nine_counter(0)) # (zero_to_nine_counter(1))))))
...
PORT MAP (
	...
	datac => zero_to_nine_counter(1),
	datad => zero_to_nine_counter(3),
	combout => \decoded_out~4_combout\);

-- Location: LCCOMB_X27_Y28_N24
\decoded_out~5\ : cycloneiii_lcell_comb
-- Equation(s):
-- \decoded_out~5_combout\ = (!zero_to_nine_counter(3) & ((zero_to_nine_counter(2) & (zero_to_nine_counter(0) & zero_to_nine_counter(1))) # (!zero_to_nine_counter(2) & ((!zero_to_nine_counter(1))))))
...
PORT MAP (
	...
	datac => zero_to_nine_counter(1),
	datad => zero_to_nine_counter(3),
	combout => \decoded_out~5_combout\);

-- Location: LCCOMB_X27_Y28_N26
\decoded_out~6\ : cycloneiii_lcell_comb
-- Equation(s):
-- \decoded_out~6_combout\ = ((!zero_to_nine_counter(2) & !zero_to_nine_counter(1))) # (!zero_to_nine_counter(3))
...
ww_decoded_out(0) <= \decoded_out[0]~output_o\;

ww_decoded_out(1) <= \decoded_out[1]~output_o\;

ww_decoded_out(2) <= \decoded_out[2]~output_o\;

ww_decoded_out(3) <= \decoded_out[3]~output_o\;

ww_decoded_out(4) <= \decoded_out[4]~output_o\;

ww_decoded_out(5) <= \decoded_out[5]~output_o\;

ww_decoded_out(6) <= \decoded_out[6]~output_o\;

ww_decoded_out(7) <= \decoded_out[7]~output_o\;

ww_temp <= \temp~output_o\;
END structure;
