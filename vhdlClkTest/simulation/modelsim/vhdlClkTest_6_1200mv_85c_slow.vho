...
-- light_out	=>  Location: PIN_B1,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF vhdlClkTest IS
...
SIGNAL \div_490196_counter[18]~clkctrl_INCLK_bus\ : std_logic_vector(3 DOWNTO 0);
...
SIGNAL \div_490196_counter[18]~clkctrl_outclk\ : std_logic;
...
\div_490196_counter[18]~clkctrl_INCLK_bus\ <= (vcc & vcc & vcc & div_490196_counter(18));
...
-- Equation(s):
-- \div_490196_counter~12_combout\ = (\Add0~2_combout\ & ((!\Equal0~5_combout\) # (!\Equal0~0_combout\)))
...
-- Equation(s):
-- \div_490196_counter~11_combout\ = (\Add0~4_combout\ & ((!\Equal0~5_combout\) # (!\Equal0~0_combout\)))
...
-- Equation(s):
-- \Equal0~0_combout\ = (!div_490196_counter(1) & (div_490196_counter(2) & div_490196_counter(0)))
...
-- Equation(s):
-- \div_490196_counter~10_combout\ = (\Add0~8_combout\ & ((!\Equal0~0_combout\) # (!\Equal0~5_combout\)))
...
-- Equation(s):
-- \div_490196_counter~9_combout\ = (\Add0~10_combout\ & ((!\Equal0~5_combout\) # (!\Equal0~0_combout\)))
...
-- Equation(s):
-- \div_490196_counter~8_combout\ = (\Add0~14_combout\ & ((!\Equal0~5_combout\) # (!\Equal0~0_combout\)))
...
-- Equation(s):
-- \div_490196_counter~7_combout\ = (\Add0~18_combout\ & ((!\Equal0~0_combout\) # (!\Equal0~5_combout\)))
...
-- Equation(s):
-- \div_490196_counter~6_combout\ = (\Add0~22_combout\ & ((!\Equal0~0_combout\) # (!\Equal0~5_combout\)))
...
-- Equation(s):
-- \div_490196_counter~5_combout\ = (\Add0~24_combout\ & ((!\Equal0~0_combout\) # (!\Equal0~5_combout\)))
...
-- Equation(s):
-- \div_490196_counter~4_combout\ = (\Add0~26_combout\ & ((!\Equal0~0_combout\) # (!\Equal0~5_combout\)))
...
-- Equation(s):
-- \div_490196_counter~3_combout\ = (\Add0~28_combout\ & ((!\Equal0~0_combout\) # (!\Equal0~5_combout\)))
...
-- Equation(s):
-- \div_490196_counter~2_combout\ = (\Add0~32_combout\ & ((!\Equal0~0_combout\) # (!\Equal0~5_combout\)))
...
-- Equation(s):
-- \div_490196_counter~1_combout\ = (\Add0~34_combout\ & ((!\Equal0~0_combout\) # (!\Equal0~5_combout\)))
...
-- Equation(s):
-- \Equal0~1_combout\ = (!div_490196_counter(15) & (div_490196_counter(18) & (div_490196_counter(17) & div_490196_counter(16))))
...
PORT MAP (
	...
	datad => div_490196_counter(16),
	combout => \Equal0~1_combout\);

-- Location: LCCOMB_X27_Y3_N8
\Equal0~2\ : cycloneiii_lcell_comb
-- Equation(s):
-- \Equal0~2_combout\ = (div_490196_counter(13) & (div_490196_counter(14) & (div_490196_counter(12) & div_490196_counter(11))))
...
-- pragma translate_on
PORT MAP (
	dataa => div_490196_counter(13),
	datab => div_490196_counter(14),
	datac => div_490196_counter(12),
...
-- Equation(s):
-- \Equal0~4_combout\ = (!div_490196_counter(3) & (div_490196_counter(5) & (!div_490196_counter(6) & div_490196_counter(4))))
...
-- pragma translate_on
PORT MAP (
	dataa => div_490196_counter(3),
	datab => div_490196_counter(5),
	datac => div_490196_counter(6),
...
-- Equation(s):
-- \Equal0~3_combout\ = (!div_490196_counter(10) & (div_490196_counter(9) & (!div_490196_counter(8) & div_490196_counter(7))))
...
-- Equation(s):
-- \Add0~36_combout\ = \Add0~35\ $ (!div_490196_counter(18))
...
-- Equation(s):
-- \div_490196_counter~0_combout\ = (\Add0~36_combout\ & ((!\Equal0~0_combout\) # (!\Equal0~5_combout\)))
...
\div_490196_counter[18]~clkctrl\ : cycloneiii_clkctrl
-- pragma translate_off
GENERIC MAP (
	clock_type => "global clock",
	ena_register_mode => "none")
-- pragma translate_on
PORT MAP (
	inclk => \div_490196_counter[18]~clkctrl_INCLK_bus\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	outclk => \div_490196_counter[18]~clkctrl_outclk\);
...
-- pragma translate_on
PORT MAP (
	clk => \div_490196_counter[18]~clkctrl_outclk\,
	d => \Add1~0_combout\,
	clrn => \reset~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \led_counter~1_combout\ = (\Add1~10_combout\ & (((!led_counter(0)) # (!\Equal1~0_combout\)) # (!\Equal1~1_combout\)))
...
-- Equation(s):
-- \led_counter~0_combout\ = (\Add1~12_combout\ & (((!\Equal1~0_combout\) # (!led_counter(0))) # (!\Equal1~1_combout\)))
...
-- Equation(s):
-- \Add1~14_combout\ = (led_counter(7) & (!\Add1~13\)) # (!led_counter(7) & ((\Add1~13\) # (GND)))
-- \Add1~15\ = CARRY((!\Add1~13\) # (!led_counter(7)))
...
-- Equation(s):
-- \Add1~16_combout\ = led_counter(8) $ (!\Add1~15\)
...
-- Equation(s):
-- \Equal1~0_combout\ = (led_counter(6) & (led_counter(5) & (!led_counter(8) & !led_counter(7))))
...
-- Equation(s):
-- \led_counter~3_combout\ = (\Add1~2_combout\ & (((!led_counter(0)) # (!\Equal1~0_combout\)) # (!\Equal1~1_combout\)))
...
-- Equation(s):
-- \led_counter~2_combout\ = (\Add1~4_combout\ & (((!\Equal1~0_combout\) # (!led_counter(0))) # (!\Equal1~1_combout\)))
...
-- Equation(s):
-- \Equal1~1_combout\ = (!led_counter(3) & (!led_counter(1) & (led_counter(2) & !led_counter(4))))
...
-- Equation(s):
-- \light_out~0_combout\ = \light_out~reg0_q\ $ (((\Equal1~1_combout\ & (led_counter(0) & \Equal1~0_combout\))))
